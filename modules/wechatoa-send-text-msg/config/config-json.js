  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://wechatoa.herokuapp.com/msg`,
    ...
    configurationArguments: {
      publish: {
        url: `https://${req.headers.host}/modules/wechatoa-send-text-msg/publish`
      },
      validate: {
        url: `https://${req.headers.host}/modules/wechatoa-send-text-msg/validate`
      },
      stop: {
        url: `https://${req.headers.host}/modules/wechatoa-send-text-msg/stop`
      }
    },
    userInterfaces: {
